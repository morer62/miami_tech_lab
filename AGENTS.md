...
This repository serves **Tech Lab Miami** at `miamitechlab.com`. This file overrides inherited brand guidance under `docs/`.
...
- Canonicals, schema, Open Graph data and sitemaps use `https://miamitechlab.com` and contain only reachable routes.
