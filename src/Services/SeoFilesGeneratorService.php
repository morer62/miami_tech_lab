...
class SeoFilesGeneratorService
{
    ...
    private function generateLlms(?int $userId, bool $full): array
    {
        ...
        $lines = [
            ...
            '',
            '## Main Technology Services',
            '',
            '- AI consulting for business operators',
            '- Business workflow automation',
            '- Software strategy and digital systems',
            '- Practical technology education',
            '',
            '## Main Public Pages',
            '',
            '- Home: ' . $this->absoluteUrl('/'),
            '- About: ' . $this->absoluteUrl('/about/'),
            '- Community: ' . $this->absoluteUrl('/community/'),
            '- Events: ' . $this->absoluteUrl('/events/'),
            '- Learning Resources: ' . $this->absoluteUrl('/learn/'),
            '- Software and AI Tools: ' . $this->absoluteUrl('/software/'),
            '- AI Consulting: ' . $this->absoluteUrl('/services/ai-consulting/'),
            '- Business Automation: ' . $this->absoluteUrl('/services/business-automation/'),
