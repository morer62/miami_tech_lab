...
| `C:\xampp\htdocs\miami-tech-lab` | `miamitechlab` | Tech Lab Miami | `https://miamitechlab.com` | `ophyra-growth-hub/miamitechlab` |
...
5. Reject a seed or cycle that imports a sister brand's services, products, URLs, pricing, copy, schema identity or Cloudinary folder. For `miamitechlab`, the public brand name is always `Tech Lab Miami`.
